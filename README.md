...
## Apache Maven <img src="https://maven.apache.org/images/maven-logo-black-on-white.png" width="72" alt="Apache Maven" />


O **Apache Maven** é uma ferramenta de automação e gerenciamento de projetos Java que ajuda a organizar dependências, compilar código, executar testes e criar builds reproduzíveis. Nesta coleção, ele aparece como uma referência de engenharia para estruturar bots e serviços com mais consistência — sem representar afiliação oficial ao projeto Apache Maven.


- **Builds reproduzíveis:** comandos claros para compilar, testar e empacotar.
- **Dependências organizadas:** configuração centralizada no `pom.xml`.
- **Automação de qualidade:** testes e validações integrados ao fluxo de desenvolvimento.


[Conheça o Apache Maven na documentação oficial](https://maven.apache.org/).

## Estatísticas reais e nova fase <img src="https://github.githubassets.com/images/modules/profile/achievements/quickdraw-default.png" width="28" alt="Ícone de contribuição" />

> **Nova fase em bots, automação e IA — construindo publicamente, um commit por vez.**
>
> Os gráficos abaixo são gerados automaticamente a partir dos dados públicos deste perfil. Eles podem mudar conforme novas contribuições, repositórios e atividades forem publicados.

<div align="center">

<a href="https://github.com/asemoarturriannunespereira-prog">
  <img height="180" src="https://github-readme-stats.vercel.app/api?username=asemoarturriannunespereira-prog&show_icons=true&theme=tokyonight&hide_border=true&rank_icon=github&include_all_commits=true" alt="Estatísticas públicas do GitHub" />
</a>
<a href="https://github.com/asemoarturriannunespereira-prog">
  <img height="180" src="https://github-readme-stats.vercel.app/api/top-langs/?username=asemoarturriannunespereira-prog&layout=compact&theme=tokyonight&hide_border=true&langs_count=8" alt="Linguagens mais utilizadas publicamente" />
</a>

<a href="https://github.com/asemoarturriannunespereira-prog">
  <img src="https://streak-stats.demolab.com?user=asemoarturriannunespereira-prog&theme=tokyonight&hide_border=true" alt="Sequência pública de contribuições" />
</a>

<a href="https://github.com/asemoarturriannunespereira-prog">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=asemoarturriannunespereira-prog&theme=tokyo-night&hide_border=true&area=true" alt="Gráfico público de atividade no GitHub" />
</a>

</div>

*Fonte dos dados: atividade pública deste perfil no GitHub. Os cards são informativos e não representam números editados manualmente.*
